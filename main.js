...
function CategoryNSE() {
  var options = [
    ...
    { value: "Domain-Groups", text: "Find all Domain Groups" },
    { value: "Domain-Groups-Admin-Keyword", text: "Find Domain Groups ending with 'admin' keyword" },
    { value: "Domain-Controllers", text: "Find Domain Controllers" },
    { value: "Domain-Computers", text: "Find Domain Computers" },
    { value: "HoneyPot-Accounts", text: "Find Decoy HoneyPot Accounts" },
    { value: "User-Description-Passwords", text: "Find Default User Accounts with password in Description" },
    { value: "Domain-Trusts", text: "Map Domain Trusts" },
    { value: "DCSync-Accounts", text: "Find Principals with DCSync Rights" },
    { value: "Kerberoastable-Accounts", text: "List all Kerberoastable Accounts" },
    { value: "ASREPRoastable-Accounts", text: "Find AS-REP Roastable Users (DontReqPreAuth)" },
    { value: "UnConstrained-Delegation-Computers", text: "Find UnConstrained Delegration Enabled Workstations" },
    { value: "Constrained-Delegation-Computers", text: "Find Constrained Delegration Enabled Workstations" },
    { value: "Domain-Users-RDP-Computers", text: "Find Workstations where Domain Users can RDP" },
    { value: "LAPS-Enabled-Computers", text: "Find LAPS Enabled Workstations" }
  ];
